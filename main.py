        ...
        <div style="display: flex; flex-direction: column; height: 100%; width: 100%; margin: 24px; line-height: 16px; word-wrap: break-word; font-size: 11px; font-family: Inter; justify-content: space-between;">
            <div>
                ...
                <div>
                    <table style="width: 100%; margin-top: 16px; border: 0; border-spacing: 0px 8px; line-height: 16px; word-wrap: break-word; font-size: 11px; font-family: Inter;">
                        <!--column header-->
                        <tr>
                            <td style="border-bottom: 0.5px solid grey; padding-right: 8px; font-weight: bold;" align="left">Datum</td>
                            <td style="border-bottom: 0.5px solid grey; padding-right: 8px; font-weight: bold;" align="left">Factuurnr.</td>
                            <td style="border-bottom: 0.5px solid grey; padding-right: 8px; font-weight: bold;" align="left">Leverancier.</td>
                            <td style="border-bottom: 0.5px solid grey; padding-right: 8px; font-weight: bold;" align="left">Omschrijving</td>
                            <td style="border-bottom: 0.5px solid grey; width: 72px; padding-right: 8px; font-weight: bold;" align="right">BTW</td>
                            <td style="border-bottom: 0.5px solid grey; width: 72px; padding-left: 4px; font-weight: bold;" align="right">Totaal</td>
                        </tr>
                        {content}
                    </table>
                </div>
            ...
            <div>
                <table style="width: 100%; margin-top: 16px; border: 0; border-spacing: 0px 8px; line-height: 16px; word-wrap: break-word; font-size: 11px; font-family: Inter;">
                    <!--footer-->
                    <tr>
                        <td style="border-top: 0.5px solid grey; padding-right: 8px; font-weight: bold;" align="left">Totaal</td>
                        <td style="border-top: 0.5px solid grey; padding-right: 8px; font-weight: bold;" align="left"></td>
                        <td style="border-top: 0.5px solid grey; padding-right: 8px; font-weight: bold;" align="left"></td>
                        <td style="border-top: 0.5px solid grey; padding-right: 8px; font-weight: bold;" align="left"></td>
                        <td style="border-top: 0.5px solid grey; width: 72px; padding-right: 8px; font-weight: bold;" align="right">&euro;{sum_vat_amount}</td>
                        <td style="border-top: 0.5px solid grey; width: 72px; padding-left: 4px; font-weight: bold;" align="right">&euro;{sum_total_amount}</td>
                    </tr>
                </table>
            </div>
        </div>
